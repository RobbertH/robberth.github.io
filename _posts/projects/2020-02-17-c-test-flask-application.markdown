...
The hardest part in building this app was the generation of the C-test based on an article: I had to find a way to render just a word at one time, but an input form at another time.
